"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(e,t,n){n.d(t,{JU:function(){return n8},ad:function(){return rt},pl:function(){return rg}});var r,i,s=n(5816),a=n(8463),o=n(3333),l=n(4444),u=n(6640);n(3454);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n3{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new n3(this.firestore,e,this._query)}}class n6{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new n5(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new n6(this.firestore,e,this._key)}}class n5 extends n3{constructor(e,t,n){super(e,t,new eH(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let e=this._path.popLast();return e.isEmpty()?null:new n6(this.firestore,null,new B(e))}withConverter(e){return new n5(this.firestore,e,this._path)}}function n8(e,t,...n){if(e=(0,l.m9)(e),1==arguments.length&&(t=R.V()),/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
